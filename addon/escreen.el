...
;;; Copyright (C) 1992, 1994, 1995, 1997 Noah S. Friedman
...
;; LCD Archive Entry:
;; escreen|Noah Friedman|friedman@prep.ai.mit.edu|
;; emacs window session manager|
;; $Date: 2005-11-26 01:15:01 $|$Revision: 1.1 $|~/misc/escreen.el.gz|

;;; $Id: escreen.el,v 1.1 2005-11-26 01:15:01 hute37 Exp $
...
;; Emacs 19.30 supports menu bars on ascii terminals, but beware of turning
;; them off or on once escreen is loaded; if a stored window configuration
;; was for a frame with a menu bar, but there is no menu bar presently,
;; that will crash emacs.  This isn't fixed even in Emacs 19.34.
