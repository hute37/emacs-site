...
;; Fixes for Debian
(if (file-readable-p (concat "/usr/share/emacs-snapshot/site-lisp/psgml" "/psgml.elc"))
    (progn
      
      (if (fboundp 'debian-pkg-add-load-path-item)
	  (setq load-path (debian-pkg-add-load-path-item "/usr/share/emacs-snapshot/site-lisp/psgml"))
	(setq load-path (cons "/usr/share/emacs-snapshot/site-lisp/psgml" load-path)))
