   ...
   '((eval setq-local denote-directory
     ...
     (eval setq-local org-cite-global-bibliography
           (list
            (expand-file-name "notes/ref/references.bib"
                              (locate-dominating-file default-directory ".dir-locals.el"))))
     (eval add-to-list 'org-agenda-files
           (buffer-file-name)
           'append)))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "Iosevka Fixed Curly Slab" :foundry "BE5N" :slant normal :weight medium :height 158 :width normal))))
