...
:END:
** LaTeX
   * [[https://gitlab.com/ub-dems-public/ds-labs/dve-sample-r/-/blob/develop/docker/r-images/scripts/base/install_ubs-commons.sh?ref_type=heads#L174][install_ubs-commons.sh#latex]]
...
:END:
** UV
   * [[https://gitlab.com/ub-dems-public/ds-labs/dve-sample-py/-/blob/develop/notes/setup/setup.org?ref_type=heads][dve-sample-py/notes/setup/setup.org]]
