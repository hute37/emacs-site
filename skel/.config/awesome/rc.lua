...
mymainmenu = awful.menu({ items = { 
        { "Terminal-X", terminal },
        { "Terminal-R", "urxvt" },
        { "Terminal-G", "gnome-terminal" },
        { "Terminal-T", "terminator" },
...
-- {{{ Vicious
-- @see: https://awesomewm.org/wiki/Vicious
...
vicious.register(memtwidget, vicious.widgets.mem, " $1% [$2M] ", 13)
...
-- vicious.register(cputwidget, vicious.widgets.cpu, "$1%")
...
globalkeys = awful.util.table.join(
   ...
   awful.key({ altkey }, "Print", function () awful.util.spawn("scrot -u -e 'mv $f ~/Pictures/ 2>/dev/null'") end),
