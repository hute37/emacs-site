...
-- calendar
lain.widgets.calendar:attach(mytextclock, { font = "monospace" })
...
-- TRAY
trayicon = wibox.widget.imagebox()
traywidget = lain.widgets.cpu({
    settings = function()
        widget:set_text("")
    end
})
...
for s = 1, screen.count() do
    ...
    if s == 1 then right_layout:add(trayicon) end
